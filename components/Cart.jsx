...
import { handleCart,deleteCartItem,incrementItem,decrementItem, subTotal} from '../slices/counterSlice';
const Cart = () => {
  ...
  return (
    <div className={`max-h-screen z-50 overflow-y-auto max-w-full md:max-w-[30%] fixed p-5 top-0 right-0 bg-pink-200 transform transition-transform ${!Cart?'translate-x-full':'translate-x-0'} duration-500`}>
      ...
      </div>:<h1 className="mt-5 font-semibold text-xl">Your Shopping Cart is Empty</h1>}
      {/* Item Box */}
